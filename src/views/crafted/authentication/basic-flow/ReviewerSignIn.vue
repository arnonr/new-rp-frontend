      ...
      <div class="auth-card">
        ...
        >
          ...
          <div class="text-center mb-8">
            ...
            <p class="auth-subtitle">สำหรับกรรมการ</p>
          </div>
...
defineOptions({ name: "reviewer-sign-in" });

const authStore = useAuthReviewerStore();
...
const initialValues = { username: "arnonr@gmail.com", password: "demo" };
